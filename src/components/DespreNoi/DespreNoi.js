    ...
    return (
        <BrowserRouter>
            ...
            <div className="despre-noi">
                <div class="despre-noi-top">

                    <div class="despre-noi-top-content">
                ...
                <Container>
                    ...
                    <div class="despre-noi-bottom">


                        <div class="despre-noi-bottom-img">
                            <img src="./images/desprenoibottom.png" alt="img" />
                        </div>
                        <div class="despre-noi-bottom-content">
                            <h3>Aici iformatie mai ampla despre companie</h3>
                            <p class="despre-noi-bottom-about">
                            ...
                            <p class="despre-noi-bottom-about">  Ut sed tempus, porta aenean aenean tincidunt pharetra vestibulum ullamcorper.</p>
                            <p class="despre-noi-bottom-about">
